\phantomsection
\protect \addcontentsline{toc}{chapter}{Acronyms}
\mtcaddchapter
...
\begin{acronym}[NFV-MANO] % längste Abkürzung steht in eckigen Klammern
    ...
    % G
    \acro{GaaS}{Gateway-as-a-Service}
    ...
    \acro{TDD}{Test Drivin Development}
