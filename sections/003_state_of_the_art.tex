...
% PC-based network devices have been available since decades, but generally owned by small companies or networking enthusiasts who can not afford commercial devices .\cite[cf.]{Noble:2015}
% In the last years these devices became popular again.
...
\todo{Some of the values to the NFV concept are speed, agility, and cost reduction. By centralizing designs around commodity server hardware, network operators can:
...
Achieve Reduction of system complexity.}\cite[cf.]{Noble:2015}
