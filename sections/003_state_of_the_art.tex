...
Two of them the "Cluster Organization" and the "Mesh Organization" are mentioned in the work.\autocite[cf.][p. 4]{Bellavista:2017}
Former is based on a tree hierarchie.
Multiple fog devices are connected to one gateway.
...
In the mesh organization every gateway can be interconnected to each other.
There are one or more gateways that are connected to the cloud.
