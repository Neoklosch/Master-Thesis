...
The \textit{Bare-Metal Virtualization} on the left side, that is numbered among the system virtualization, use a \textit{Hypervisor} that is executed between the soft- and hardware layer.
...
All of the \acp{VM} are completely isolated form each other.
...
The \textit{Container Engine} itself manages the containers and isolates them.
...
With \textit{Container Virtualization}, there is no need to start a \textit{Guest \ac{OS}}, which maeks it more lightweight and less resource consuming compared to system virtualization.
...
% TODO: source for the following sentence
...
As mentioned in the paper, there is significant space for improvements, like a working orchestration engine, some data and network management aspects and better semantic descriptions. % TODO: Hier wäre eine Schlussfolgerung für deine Arbeit prima oder eine Reflektion dieser Aussage
