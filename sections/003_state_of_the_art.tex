...
"It enables virtual Network Services deployments on top of heterogeneous NFV Infrastructures."\cite{openBatonDoc}
...
% you should mention OpenStack in here
...
\begin{figure}[H]
    ...
    \caption[Open Baton architecture]{Open Baton architecture. Adapted from: \cite{openBatonDoc}}
    \label{fig:open_baton_architecture}
\end{figure}
