...
The aim of this work is to create a prototype for a fog node, which can deploy containers on the same node or on other network nodes, which are typically low power devices at the edge of a network, especially for the area of Industry 4.0 and smart factories.
...
The cooperation with the Fraunhofer FOKUS plays a prominent role for this thesis, because they have a lot of knowledge and experience especially in this area of \ac{IoT} and \ac{NFV}.
...
As mentioned before, the prototype will be an plugin for Open Baton, which means that the creation of an \ac{MANO} engine is out of scope for this thesis.
