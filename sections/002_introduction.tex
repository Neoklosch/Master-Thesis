...
The aim of this work is to create a plugin for Open Baton, an \ac{ETSI} \ac{NFV} compliant \ac{MANO} framework, which can deploy Docker container to network nodes, typically lower power devices at the edge of a network, especially for the area of Industry 4.0 and smart factories.
