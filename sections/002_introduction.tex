...
A for Node is typically a low power device at the edge of a network, especially in the area of Industry 4.0 and smart factories.
...
As mentioned before, the prototype will be an prototype for a fog node, this means the creation of a \ac{MANO} engine on the server side is out of scope for this thesis.
