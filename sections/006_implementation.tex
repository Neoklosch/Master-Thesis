...
\paragraph{dependency-injector} is a micro framework for \acf{DI} in Python.
...
As discussed by the other servers, also this one has to be executed in threads.
...
\end{minted}
\captionof{listing}{Travis CI configuration file\label{code:travis_config}}
\vspace{0.5cm}
...
It will check to code against the \ac{PEP} 8 standard\footnote{\url{https://www.python.org/dev/peps/pep-0008}}, which is used by several other libraries like the pretty famous Django project{\interfootnotelinepenalty10000 \footnote{\url{https://docs.djangoproject.com/en/dev/internals/contributing/writing-code/coding-style}}}.
...
\end{minted}
\captionof{listing}{Extract from the Motey unit test of the ServiceRepository\label{code:sample_unit_test}}
\vspace{0.5cm}
