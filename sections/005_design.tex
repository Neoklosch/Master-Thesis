...
% -> implemented via webserver, mqttserver, ZeroMQ endpoints
% orchestration for deployment of containers and communication with other nodes
% Monitoring Agent for logging all the stuff
% VAL for abstracting possible virtualization tools like docker, xen, etc.
% hardware event handler should interact to with hardware level, e.g. now device connected, etc.
% MVC ohne View
