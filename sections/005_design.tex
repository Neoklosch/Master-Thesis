...
There are a lot of well designed and developed established libraries and tools out there, which makes it easy to create rapid prototypes.
...
It will be mainly used for the communication with the centralized fog level, because most of the orchestration tools out there are using \ac{REST} for transferring data.
